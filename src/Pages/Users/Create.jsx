...
export default function Create() {
  ...
  return (
    <form onSubmit={handleCreate} className="w-3xl mx-auto my-8">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base/7 font-semibold text-gray-900">Informações de cadastro de usuário</h2>
